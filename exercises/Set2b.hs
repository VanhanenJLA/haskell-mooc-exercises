...
-- oddFactorial 0 = 1
-- oddFactorial even = oddFactorial(n-1)
-- oddFactorial odd  = n * oddFactorial(n-1)
...
countdown i = "Ready! " ++ helper i "" ++ " Liftoff!"

helper :: Integer -> String -> String
helper i s
  | i > 0 = helper (i-1) (s ++ " " ++ show i ++ "...")
  | otherwise = s
