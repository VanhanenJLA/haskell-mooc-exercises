...
frequenciesProp freq input = conjoin [sumIsLength (getNonEmpty input) (freq (getNonEmpty input)), inputInOutput (getNonEmpty input) (freq (getNonEmpty input)), outputInInput (getNonEmpty input) (freq (getNonEmpty input))]
